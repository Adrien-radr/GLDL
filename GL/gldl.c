...
void gldlTexImage1D ( GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *arg7, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glTexImage1D( %s, %d, %d, %d, %d, %s, %s, %s );\n", file, line, arg0, level, internalformat, width, border, arg5, arg6,  arg7 );

    DebugTest( 395 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glTexImage1D( target=%s, level=%d, internalformat=%d, width=%d, border=%d, format=%s, type=%s, pixels=%s ) at %s:%d\n", debug_break, arg0, level, internalformat, width, border, arg5, arg6, arg7, file, line );
        DebugFunction();
    }
...
void gldlTexImage2D ( GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *arg7, const char *arg8, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glTexImage2D( %s, %d, %d, %d, %d, %d, %s, %s, %s );\n", file, line, arg0, level, internalformat, width, height, border, arg6, arg7,  arg8 );

    DebugTest( 396 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glTexImage2D( target=%s, level=%d, internalformat=%d, width=%d, height=%d, border=%d, format=%s, type=%s, pixels=%s ) at %s:%d\n", debug_break, arg0, level, internalformat, width, height, border, arg6, arg7, arg8, file, line );
        DebugFunction();
    }
...
void gldlReadPixels ( GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid *pixels, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glReadPixels( %d, %d, %d, %d, %s, %s, %s );\n", file, line, x, y, width, height, arg4, arg5,  arg6 );

    DebugTest( 358 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glReadPixels( x=%d, y=%d, width=%d, height=%d, format=%s, type=%s, pixels=%s ) at %s:%d\n", debug_break, x, y, width, height, arg4, arg5, arg6, file, line );
        DebugFunction();
    }
...
void gldlGetTexImage ( GLenum target, GLint level, GLenum format, GLenum type, GLvoid *pixels, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetTexImage( %s, %d, %s, %s, %s );\n", file, line, arg0, level, arg2, arg3,  arg4 );

    DebugTest( 211 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetTexImage( target=%s, level=%d, format=%s, type=%s, pixels=%s ) at %s:%d\n", debug_break, arg0, level, arg2, arg3, arg4, file, line );
        DebugFunction();
    }
...
void gldlGetTexLevelParameterfv ( GLenum target, GLint level, GLenum pname, GLfloat *params, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetTexLevelParameterfv( %s, %d, %s, %s );\n", file, line, arg0, level, arg2,  arg3 );

    DebugTest( 212 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetTexLevelParameterfv( target=%s, level=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, arg0, level, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetTexLevelParameteriv ( GLenum target, GLint level, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetTexLevelParameteriv( %s, %d, %s, %s );\n", file, line, arg0, level, arg2,  arg3 );

    DebugTest( 213 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetTexLevelParameteriv( target=%s, level=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, arg0, level, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlDrawElements ( GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDrawElements( %s, %d, %s, %s );\n", file, line, arg0, count, arg2,  arg3 );

    DebugTest( 106 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDrawElements( mode=%s, count=%d, type=%s, indices=%s ) at %s:%d\n", debug_break, arg0, count, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlTexSubImage1D ( GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glTexSubImage1D( %s, %d, %d, %d, %s, %s, %s );\n", file, line, arg0, level, xoffset, width, arg4, arg5,  arg6 );

    DebugTest( 409 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glTexSubImage1D( target=%s, level=%d, xoffset=%d, width=%d, format=%s, type=%s, pixels=%s ) at %s:%d\n", debug_break, arg0, level, xoffset, width, arg4, arg5, arg6, file, line );
        DebugFunction();
    }
...
void gldlTexSubImage2D ( GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *arg7, const char *arg8, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glTexSubImage2D( %s, %d, %d, %d, %d, %d, %s, %s, %s );\n", file, line, arg0, level, xoffset, yoffset, width, height, arg6, arg7,  arg8 );

    DebugTest( 410 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glTexSubImage2D( target=%s, level=%d, xoffset=%d, yoffset=%d, width=%d, height=%d, format=%s, type=%s, pixels=%s ) at %s:%d\n", debug_break, arg0, level, xoffset, yoffset, width, height, arg6, arg7, arg8, file, line );
        DebugFunction();
    }
...
void gldlDeleteTextures ( GLsizei n, const GLuint *textures, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDeleteTextures( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 87 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDeleteTextures( n=%d, textures=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlGenTextures ( GLsizei n, GLuint *textures, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGenTextures( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 143 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGenTextures( n=%d, textures=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlDrawRangeElements ( GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDrawRangeElements( %s, %d, %d, %d, %s, %s );\n", file, line, arg0, start, end, count, arg4,  arg5 );

    DebugTest( 113 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDrawRangeElements( mode=%s, start=%d, end=%d, count=%d, type=%s, indices=%s ) at %s:%d\n", debug_break, arg0, start, end, count, arg4, arg5, file, line );
        DebugFunction();
    }
...
void gldlTexImage3D ( GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *pixels, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *arg7, const char *arg8, const char *arg9, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glTexImage3D( %s, %d, %d, %d, %d, %d, %d, %s, %s, %s );\n", file, line, arg0, level, internalformat, width, height, depth, border, arg7, arg8,  arg9 );

    DebugTest( 398 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glTexImage3D( target=%s, level=%d, internalformat=%d, width=%d, height=%d, depth=%d, border=%d, format=%s, type=%s, pixels=%s ) at %s:%d\n", debug_break, arg0, level, internalformat, width, height, depth, border, arg7, arg8, arg9, file, line );
        DebugFunction();
    }
...
void gldlTexSubImage3D ( GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *arg7, const char *arg8, const char *arg9, const char *arg10, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glTexSubImage3D( %s, %d, %d, %d, %d, %d, %d, %d, %s, %s, %s );\n", file, line, arg0, level, xoffset, yoffset, zoffset, width, height, depth, arg8, arg9,  arg10 );

    DebugTest( 411 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glTexSubImage3D( target=%s, level=%d, xoffset=%d, yoffset=%d, zoffset=%d, width=%d, height=%d, depth=%d, format=%s, type=%s, pixels=%s ) at %s:%d\n", debug_break, arg0, level, xoffset, yoffset, zoffset, width, height, depth, arg8, arg9, arg10, file, line );
        DebugFunction();
    }
...
void gldlCompressedTexImage3D ( GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid *data, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *arg7, const char *arg8, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glCompressedTexImage3D( %s, %d, %s, %d, %d, %d, %d, %d, %s );\n", file, line, arg0, level, arg2, width, height, depth, border, imageSize,  arg8 );

    DebugTest( 59 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glCompressedTexImage3D( target=%s, level=%d, internalformat=%s, width=%d, height=%d, depth=%d, border=%d, imageSize=%d, data=%s ) at %s:%d\n", debug_break, arg0, level, arg2, width, height, depth, border, imageSize, arg8, file, line );
        DebugFunction();
    }
...
void gldlCompressedTexImage2D ( GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *data, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *arg7, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glCompressedTexImage2D( %s, %d, %s, %d, %d, %d, %d, %s );\n", file, line, arg0, level, arg2, width, height, border, imageSize,  arg7 );

    DebugTest( 58 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glCompressedTexImage2D( target=%s, level=%d, internalformat=%s, width=%d, height=%d, border=%d, imageSize=%d, data=%s ) at %s:%d\n", debug_break, arg0, level, arg2, width, height, border, imageSize, arg7, file, line );
        DebugFunction();
    }
...
void gldlCompressedTexImage1D ( GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid *data, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glCompressedTexImage1D( %s, %d, %s, %d, %d, %d, %s );\n", file, line, arg0, level, arg2, width, border, imageSize,  arg6 );

    DebugTest( 57 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glCompressedTexImage1D( target=%s, level=%d, internalformat=%s, width=%d, border=%d, imageSize=%d, data=%s ) at %s:%d\n", debug_break, arg0, level, arg2, width, border, imageSize, arg6, file, line );
        DebugFunction();
    }
...
void gldlCompressedTexSubImage3D ( GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid *data, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *arg7, const char *arg8, const char *arg9, const char *arg10, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glCompressedTexSubImage3D( %s, %d, %d, %d, %d, %d, %d, %d, %s, %d, %s );\n", file, line, arg0, level, xoffset, yoffset, zoffset, width, height, depth, arg8, imageSize,  arg10 );

    DebugTest( 62 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glCompressedTexSubImage3D( target=%s, level=%d, xoffset=%d, yoffset=%d, zoffset=%d, width=%d, height=%d, depth=%d, format=%s, imageSize=%d, data=%s ) at %s:%d\n", debug_break, arg0, level, xoffset, yoffset, zoffset, width, height, depth, arg8, imageSize, arg10, file, line );
        DebugFunction();
    }
...
void gldlCompressedTexSubImage2D ( GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *data, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *arg7, const char *arg8, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glCompressedTexSubImage2D( %s, %d, %d, %d, %d, %d, %s, %d, %s );\n", file, line, arg0, level, xoffset, yoffset, width, height, arg6, imageSize,  arg8 );

    DebugTest( 61 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glCompressedTexSubImage2D( target=%s, level=%d, xoffset=%d, yoffset=%d, width=%d, height=%d, format=%s, imageSize=%d, data=%s ) at %s:%d\n", debug_break, arg0, level, xoffset, yoffset, width, height, arg6, imageSize, arg8, file, line );
        DebugFunction();
    }
...
void gldlCompressedTexSubImage1D ( GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid *data, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glCompressedTexSubImage1D( %s, %d, %d, %d, %s, %d, %s );\n", file, line, arg0, level, xoffset, width, arg4, imageSize,  arg6 );

    DebugTest( 60 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glCompressedTexSubImage1D( target=%s, level=%d, xoffset=%d, width=%d, format=%s, imageSize=%d, data=%s ) at %s:%d\n", debug_break, arg0, level, xoffset, width, arg4, imageSize, arg6, file, line );
        DebugFunction();
    }
...
void gldlGetCompressedTexImage ( GLenum target, GLint level, GLvoid *img, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetCompressedTexImage( %s, %d, %s );\n", file, line, arg0, level,  arg2 );

    DebugTest( 165 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetCompressedTexImage( target=%s, level=%d, img=%s ) at %s:%d\n", debug_break, arg0, level, arg2, file, line );
        DebugFunction();
    }
...
void gldlMultiDrawArrays ( GLenum mode, const GLint *first, const GLsizei *count, GLsizei primcount, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glMultiDrawArrays( %s, %s, %s, %d );\n", file, line, arg0, arg1, arg2,  primcount );

    DebugTest( 276 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glMultiDrawArrays( mode=%s, first=%s, count=%s, primcount=%d ) at %s:%d\n", debug_break, arg0, arg1, arg2, primcount, file, line );
        DebugFunction();
    }
...
void gldlMultiDrawElements ( GLenum mode, const GLsizei *count, GLenum type, const GLvoid* *indices, GLsizei primcount, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glMultiDrawElements( %s, %s, %s, %s, %d );\n", file, line, arg0, arg1, arg2, arg3,  primcount );

    DebugTest( 277 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glMultiDrawElements( mode=%s, count=%s, type=%s, indices=%s, primcount=%d ) at %s:%d\n", debug_break, arg0, arg1, arg2, arg3, primcount, file, line );
        DebugFunction();
    }
...
void gldlGenQueries ( GLsizei n, GLuint *ids, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGenQueries( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 140 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGenQueries( n=%d, ids=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlDeleteQueries ( GLsizei n, const GLuint *ids, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDeleteQueries( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 82 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDeleteQueries( n=%d, ids=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlGetQueryObjectiv ( GLuint id, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetQueryObjectiv( %d, %s, %s );\n", file, line, id, arg1,  arg2 );

    DebugTest( 193 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetQueryObjectiv( id=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, id, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetQueryObjectuiv ( GLuint id, GLenum pname, GLuint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetQueryObjectuiv( %d, %s, %s );\n", file, line, id, arg1,  arg2 );

    DebugTest( 195 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetQueryObjectuiv( id=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, id, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlDeleteBuffers ( GLsizei n, const GLuint *buffers, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDeleteBuffers( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 77 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDeleteBuffers( n=%d, buffers=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlGenBuffers ( GLsizei n, GLuint *buffers, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGenBuffers( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 137 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGenBuffers( n=%d, buffers=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlBufferData ( GLenum target, GLsizeiptr size, const GLvoid *data, GLenum usage, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glBufferData( %s, %d, %s, %s );\n", file, line, arg0, (int)size, arg2,  arg3 );

    DebugTest( 35 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glBufferData( target=%s, size=%d, data=%s, usage=%s ) at %s:%d\n", debug_break, arg0, (int)size, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlBufferSubData ( GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid *data, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glBufferSubData( %s, %d, %d, %s );\n", file, line, arg0, (int)offset, (int)size,  arg3 );

    DebugTest( 36 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glBufferSubData( target=%s, offset=%d, size=%d, data=%s ) at %s:%d\n", debug_break, arg0, (int)offset, (int)size, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetBufferSubData ( GLenum target, GLintptr offset, GLsizeiptr size, GLvoid *data, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetBufferSubData( %s, %d, %d, %s );\n", file, line, arg0, (int)offset, (int)size,  arg3 );

    DebugTest( 164 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetBufferSubData( target=%s, offset=%d, size=%d, data=%s ) at %s:%d\n", debug_break, arg0, (int)offset, (int)size, arg3, file, line );
        DebugFunction();
    }
...
void gldlDrawBuffers ( GLsizei n, const GLenum *bufs, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDrawBuffers( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 105 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDrawBuffers( n=%d, bufs=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlBindAttribLocation ( GLuint program, GLuint index, const GLchar *name, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glBindAttribLocation( %d, %d, %s );\n", file, line, program, index,  arg2 );

    DebugTest( 7 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glBindAttribLocation( program=%d, index=%d, name=%s ) at %s:%d\n", debug_break, program, index, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetActiveAttrib ( GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLint *size, GLenum *type, GLchar *name, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetActiveAttrib( %d, %d, %d, %s, %s, %s, %s );\n", file, line, program, index, bufSize, arg3, arg4, arg5,  arg6 );

    DebugTest( 148 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetActiveAttrib( program=%d, index=%d, bufSize=%d, length=%s, size=%s, type=%s, name=%s ) at %s:%d\n", debug_break, program, index, bufSize, arg3, arg4, arg5, arg6, file, line );
        DebugFunction();
    }
...
void gldlGetActiveUniform ( GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLint *size, GLenum *type, GLchar *name, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetActiveUniform( %d, %d, %d, %s, %s, %s, %s );\n", file, line, program, index, bufSize, arg3, arg4, arg5,  arg6 );

    DebugTest( 152 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetActiveUniform( program=%d, index=%d, bufSize=%d, length=%s, size=%s, type=%s, name=%s ) at %s:%d\n", debug_break, program, index, bufSize, arg3, arg4, arg5, arg6, file, line );
        DebugFunction();
    }
...
void gldlGetAttachedShaders ( GLuint program, GLsizei maxCount, GLsizei *count, GLuint *obj, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetAttachedShaders( %d, %d, %s, %s );\n", file, line, program, maxCount, arg2,  arg3 );

    DebugTest( 157 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetAttachedShaders( program=%d, maxCount=%d, count=%s, obj=%s ) at %s:%d\n", debug_break, program, maxCount, arg2, arg3, file, line );
        DebugFunction();
    }
...
GLint gldlGetAttribLocation ( GLuint program, const GLchar *name, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetAttribLocation( %d, %s );\n", file, line, program,  arg1 );
...
void gldlGetProgramiv ( GLuint program, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetProgramiv( %d, %s, %s );\n", file, line, program, arg1,  arg2 );

    DebugTest( 190 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetProgramiv( program=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, program, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetProgramInfoLog ( GLuint program, GLsizei bufSize, GLsizei *length, GLchar *infoLog, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetProgramInfoLog( %d, %d, %s, %s );\n", file, line, program, bufSize, arg2,  arg3 );

    DebugTest( 186 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetProgramInfoLog( program=%d, bufSize=%d, length=%s, infoLog=%s ) at %s:%d\n", debug_break, program, bufSize, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetShaderiv ( GLuint shader, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetShaderiv( %d, %s, %s );\n", file, line, shader, arg1,  arg2 );

    DebugTest( 205 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetShaderiv( shader=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, shader, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetShaderInfoLog ( GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *infoLog, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetShaderInfoLog( %d, %d, %s, %s );\n", file, line, shader, bufSize, arg2,  arg3 );

    DebugTest( 202 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetShaderInfoLog( shader=%d, bufSize=%d, length=%s, infoLog=%s ) at %s:%d\n", debug_break, shader, bufSize, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetShaderSource ( GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *source, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetShaderSource( %d, %d, %s, %s );\n", file, line, shader, bufSize, arg2,  arg3 );

    DebugTest( 204 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetShaderSource( shader=%d, bufSize=%d, length=%s, source=%s ) at %s:%d\n", debug_break, shader, bufSize, arg2, arg3, file, line );
        DebugFunction();
    }
...
GLint gldlGetUniformLocation ( GLuint program, const GLchar *name, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetUniformLocation( %d, %s );\n", file, line, program,  arg1 );
...
void gldlGetUniformfv ( GLuint program, GLint location, GLfloat *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetUniformfv( %d, %d, %s );\n", file, line, program, location,  arg2 );

    DebugTest( 224 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetUniformfv( program=%d, location=%d, params=%s ) at %s:%d\n", debug_break, program, location, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetUniformiv ( GLuint program, GLint location, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetUniformiv( %d, %d, %s );\n", file, line, program, location,  arg2 );

    DebugTest( 225 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetUniformiv( program=%d, location=%d, params=%s ) at %s:%d\n", debug_break, program, location, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetVertexAttribdv ( GLuint index, GLenum pname, GLdouble *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetVertexAttribdv( %d, %s, %s );\n", file, line, index, arg1,  arg2 );

    DebugTest( 231 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetVertexAttribdv( index=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, index, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetVertexAttribfv ( GLuint index, GLenum pname, GLfloat *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetVertexAttribfv( %d, %s, %s );\n", file, line, index, arg1,  arg2 );

    DebugTest( 232 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetVertexAttribfv( index=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, index, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetVertexAttribiv ( GLuint index, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetVertexAttribiv( %d, %s, %s );\n", file, line, index, arg1,  arg2 );

    DebugTest( 233 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetVertexAttribiv( index=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, index, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetVertexAttribPointerv ( GLuint index, GLenum pname, GLvoid* *pointer, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetVertexAttribPointerv( %d, %s, %s );\n", file, line, index, arg1,  arg2 );

    DebugTest( 230 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetVertexAttribPointerv( index=%d, pname=%s, pointer=%s ) at %s:%d\n", debug_break, index, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlShaderSource ( GLuint shader, GLsizei count, const GLchar* *string, const GLint *length, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glShaderSource( %d, %d, %s, %s );\n", file, line, shader, count, arg2,  arg3 );

    DebugTest( 379 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glShaderSource( shader=%d, count=%d, string=%s, length=%s ) at %s:%d\n", debug_break, shader, count, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniform1fv ( GLint location, GLsizei count, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform1fv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 419 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform1fv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform2fv ( GLint location, GLsizei count, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform2fv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 427 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform2fv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform3fv ( GLint location, GLsizei count, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform3fv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 435 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform3fv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform4fv ( GLint location, GLsizei count, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform4fv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 443 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform4fv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform1iv ( GLint location, GLsizei count, const GLint *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform1iv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 421 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform1iv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform2iv ( GLint location, GLsizei count, const GLint *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform2iv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 429 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform2iv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform3iv ( GLint location, GLsizei count, const GLint *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform3iv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 437 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform3iv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform4iv ( GLint location, GLsizei count, const GLint *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform4iv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 445 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform4iv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix2fv ( GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix2fv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 450 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix2fv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix3fv ( GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix3fv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 456 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix3fv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix4fv ( GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix4fv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 462 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix4fv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib1dv ( GLuint index, const GLdouble *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib1dv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 474 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib1dv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib1fv ( GLuint index, const GLfloat *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib1fv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 476 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib1fv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib1sv ( GLuint index, const GLshort *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib1sv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 478 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib1sv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib2dv ( GLuint index, const GLdouble *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib2dv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 480 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib2dv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib2fv ( GLuint index, const GLfloat *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib2fv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 482 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib2fv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib2sv ( GLuint index, const GLshort *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib2sv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 484 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib2sv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib3dv ( GLuint index, const GLdouble *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib3dv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 486 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib3dv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib3fv ( GLuint index, const GLfloat *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib3fv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 488 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib3fv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib3sv ( GLuint index, const GLshort *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib3sv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 490 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib3sv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4Nbv ( GLuint index, const GLbyte *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4Nbv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 491 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4Nbv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4Niv ( GLuint index, const GLint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4Niv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 492 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4Niv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4Nsv ( GLuint index, const GLshort *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4Nsv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 493 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4Nsv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4Nubv ( GLuint index, const GLubyte *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4Nubv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 495 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4Nubv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4Nuiv ( GLuint index, const GLuint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4Nuiv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 496 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4Nuiv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4Nusv ( GLuint index, const GLushort *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4Nusv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 497 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4Nusv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4bv ( GLuint index, const GLbyte *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4bv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 498 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4bv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4dv ( GLuint index, const GLdouble *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4dv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 500 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4dv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4fv ( GLuint index, const GLfloat *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4fv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 502 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4fv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4iv ( GLuint index, const GLint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4iv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 503 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4iv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4sv ( GLuint index, const GLshort *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4sv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 505 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4sv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4ubv ( GLuint index, const GLubyte *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4ubv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 506 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4ubv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4uiv ( GLuint index, const GLuint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4uiv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 507 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4uiv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttrib4usv ( GLuint index, const GLushort *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttrib4usv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 508 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttrib4usv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribPointer ( GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid *pointer, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribPointer( %d, %d, %s, %d, %d, %s );\n", file, line, index, size, arg2, normalized, stride,  arg5 );

    DebugTest( 548 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribPointer( index=%d, size=%d, type=%s, normalized=%d, stride=%d, pointer=%s ) at %s:%d\n", debug_break, index, size, arg2, normalized, stride, arg5, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix2x3fv ( GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix2x3fv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 452 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix2x3fv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix3x2fv ( GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix3x2fv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 458 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix3x2fv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix2x4fv ( GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix2x4fv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 454 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix2x4fv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix4x2fv ( GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix4x2fv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 464 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix4x2fv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix3x4fv ( GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix3x4fv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 460 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix3x4fv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix4x3fv ( GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix4x3fv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 466 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix4x3fv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetBooleani_v ( GLenum target, GLuint index, GLboolean *data, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetBooleani_v( %s, %d, %s );\n", file, line, arg0, index,  arg2 );

    DebugTest( 159 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetBooleani_v( target=%s, index=%d, data=%s ) at %s:%d\n", debug_break, arg0, index, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetIntegeri_v ( GLenum target, GLuint index, GLint *data, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetIntegeri_v( %s, %d, %s );\n", file, line, arg0, index,  arg2 );

    DebugTest( 178 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetIntegeri_v( target=%s, index=%d, data=%s ) at %s:%d\n", debug_break, arg0, index, arg2, file, line );
        DebugFunction();
    }
...
void gldlTransformFeedbackVaryings ( GLuint program, GLsizei count, const GLchar* *varyings, GLenum bufferMode, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glTransformFeedbackVaryings( %d, %d, %s, %s );\n", file, line, program, count, arg2,  arg3 );

    DebugTest( 415 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glTransformFeedbackVaryings( program=%d, count=%d, varyings=%s, bufferMode=%s ) at %s:%d\n", debug_break, program, count, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetTransformFeedbackVarying ( GLuint program, GLuint index, GLsizei bufSize, GLsizei *length, GLsizei *size, GLenum *type, GLchar *name, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetTransformFeedbackVarying( %d, %d, %d, %s, %s, %s, %s );\n", file, line, program, index, bufSize, arg3, arg4, arg5,  arg6 );

    DebugTest( 218 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetTransformFeedbackVarying( program=%d, index=%d, bufSize=%d, length=%s, size=%s, type=%s, name=%s ) at %s:%d\n", debug_break, program, index, bufSize, arg3, arg4, arg5, arg6, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribIPointer ( GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribIPointer( %d, %d, %s, %d, %s );\n", file, line, index, size, arg2, stride,  arg4 );

    DebugTest( 530 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribIPointer( index=%d, size=%d, type=%s, stride=%d, pointer=%s ) at %s:%d\n", debug_break, index, size, arg2, stride, arg4, file, line );
        DebugFunction();
    }
...
void gldlGetVertexAttribIiv ( GLuint index, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetVertexAttribIiv( %d, %s, %s );\n", file, line, index, arg1,  arg2 );

    DebugTest( 227 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetVertexAttribIiv( index=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, index, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetVertexAttribIuiv ( GLuint index, GLenum pname, GLuint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetVertexAttribIuiv( %d, %s, %s );\n", file, line, index, arg1,  arg2 );

    DebugTest( 228 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetVertexAttribIuiv( index=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, index, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribI1iv ( GLuint index, const GLint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribI1iv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 511 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribI1iv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribI2iv ( GLuint index, const GLint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribI2iv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 515 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribI2iv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribI3iv ( GLuint index, const GLint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribI3iv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 519 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribI3iv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribI4iv ( GLuint index, const GLint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribI4iv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 524 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribI4iv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribI1uiv ( GLuint index, const GLuint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribI1uiv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 513 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribI1uiv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribI2uiv ( GLuint index, const GLuint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribI2uiv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 517 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribI2uiv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribI3uiv ( GLuint index, const GLuint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribI3uiv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 521 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribI3uiv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribI4uiv ( GLuint index, const GLuint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribI4uiv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 528 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribI4uiv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribI4bv ( GLuint index, const GLbyte *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribI4bv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 522 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribI4bv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribI4sv ( GLuint index, const GLshort *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribI4sv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 525 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribI4sv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribI4ubv ( GLuint index, const GLubyte *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribI4ubv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 526 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribI4ubv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribI4usv ( GLuint index, const GLushort *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribI4usv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 529 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribI4usv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlGetUniformuiv ( GLuint program, GLint location, GLuint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetUniformuiv( %d, %d, %s );\n", file, line, program, location,  arg2 );

    DebugTest( 226 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetUniformuiv( program=%d, location=%d, params=%s ) at %s:%d\n", debug_break, program, location, arg2, file, line );
        DebugFunction();
    }
...
void gldlBindFragDataLocation ( GLuint program, GLuint color, const GLchar *name, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glBindFragDataLocation( %d, %d, %s );\n", file, line, program, color,  arg2 );

    DebugTest( 11 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glBindFragDataLocation( program=%d, color=%d, name=%s ) at %s:%d\n", debug_break, program, color, arg2, file, line );
        DebugFunction();
    }
...
GLint gldlGetFragDataLocation ( GLuint program, const GLchar *name, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetFragDataLocation( %d, %s );\n", file, line, program,  arg1 );
...
void gldlUniform1uiv ( GLint location, GLsizei count, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform1uiv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 423 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform1uiv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform2uiv ( GLint location, GLsizei count, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform2uiv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 431 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform2uiv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform3uiv ( GLint location, GLsizei count, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform3uiv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 439 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform3uiv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform4uiv ( GLint location, GLsizei count, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform4uiv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 447 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform4uiv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlClearBufferiv ( GLenum buffer, GLint drawbuffer, const GLint *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glClearBufferiv( %s, %d, %s );\n", file, line, arg0, drawbuffer,  arg2 );

    DebugTest( 42 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glClearBufferiv( buffer=%s, drawbuffer=%d, value=%s ) at %s:%d\n", debug_break, arg0, drawbuffer, arg2, file, line );
        DebugFunction();
    }
...
void gldlClearBufferuiv ( GLenum buffer, GLint drawbuffer, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glClearBufferuiv( %s, %d, %s );\n", file, line, arg0, drawbuffer,  arg2 );

    DebugTest( 43 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glClearBufferuiv( buffer=%s, drawbuffer=%d, value=%s ) at %s:%d\n", debug_break, arg0, drawbuffer, arg2, file, line );
        DebugFunction();
    }
...
void gldlClearBufferfv ( GLenum buffer, GLint drawbuffer, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glClearBufferfv( %s, %d, %s );\n", file, line, arg0, drawbuffer,  arg2 );

    DebugTest( 41 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glClearBufferfv( buffer=%s, drawbuffer=%d, value=%s ) at %s:%d\n", debug_break, arg0, drawbuffer, arg2, file, line );
        DebugFunction();
    }
...
void gldlDrawElementsInstanced ( GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primcount, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDrawElementsInstanced( %s, %d, %s, %s, %d );\n", file, line, arg0, count, arg2, arg3,  primcount );

    DebugTest( 109 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDrawElementsInstanced( mode=%s, count=%d, type=%s, indices=%s, primcount=%d ) at %s:%d\n", debug_break, arg0, count, arg2, arg3, primcount, file, line );
        DebugFunction();
    }
...
void gldlGetInteger64i_v ( GLenum target, GLuint index, GLint64 *data, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetInteger64i_v( %s, %d, %s );\n", file, line, arg0, index,  arg2 );

    DebugTest( 176 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetInteger64i_v( target=%s, index=%d, data=%s ) at %s:%d\n", debug_break, arg0, index, arg2, file, line );
        DebugFunction();
    }
...
void gldlDeleteRenderbuffers ( GLsizei n, const GLuint *renderbuffers, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDeleteRenderbuffers( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 83 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDeleteRenderbuffers( n=%d, renderbuffers=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlGenRenderbuffers ( GLsizei n, GLuint *renderbuffers, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGenRenderbuffers( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 141 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGenRenderbuffers( n=%d, renderbuffers=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlDeleteFramebuffers ( GLsizei n, const GLuint *framebuffers, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDeleteFramebuffers( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 78 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDeleteFramebuffers( n=%d, framebuffers=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlGenFramebuffers ( GLsizei n, GLuint *framebuffers, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGenFramebuffers( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 138 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGenFramebuffers( n=%d, framebuffers=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlDeleteVertexArrays ( GLsizei n, const GLuint *arrays, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDeleteVertexArrays( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 89 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDeleteVertexArrays( n=%d, arrays=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlGenVertexArrays ( GLsizei n, GLuint *arrays, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGenVertexArrays( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 145 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGenVertexArrays( n=%d, arrays=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlGetUniformIndices ( GLuint program, GLsizei uniformCount, const GLchar* *uniformNames, GLuint *uniformIndices, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetUniformIndices( %d, %d, %s, %s );\n", file, line, program, uniformCount, arg2,  arg3 );

    DebugTest( 220 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetUniformIndices( program=%d, uniformCount=%d, uniformNames=%s, uniformIndices=%s ) at %s:%d\n", debug_break, program, uniformCount, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetActiveUniformsiv ( GLuint program, GLsizei uniformCount, const GLuint *uniformIndices, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetActiveUniformsiv( %d, %d, %s, %s, %s );\n", file, line, program, uniformCount, arg2, arg3,  arg4 );

    DebugTest( 156 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetActiveUniformsiv( program=%d, uniformCount=%d, uniformIndices=%s, pname=%s, params=%s ) at %s:%d\n", debug_break, program, uniformCount, arg2, arg3, arg4, file, line );
        DebugFunction();
    }
...
void gldlGetActiveUniformName ( GLuint program, GLuint uniformIndex, GLsizei bufSize, GLsizei *length, GLchar *uniformName, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetActiveUniformName( %d, %d, %d, %s, %s );\n", file, line, program, uniformIndex, bufSize, arg3,  arg4 );

    DebugTest( 155 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetActiveUniformName( program=%d, uniformIndex=%d, bufSize=%d, length=%s, uniformName=%s ) at %s:%d\n", debug_break, program, uniformIndex, bufSize, arg3, arg4, file, line );
        DebugFunction();
    }
...
GLuint gldlGetUniformBlockIndex ( GLuint program, const GLchar *uniformBlockName, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetUniformBlockIndex( %d, %s );\n", file, line, program,  arg1 );
...
void gldlGetActiveUniformBlockiv ( GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetActiveUniformBlockiv( %d, %d, %s, %s );\n", file, line, program, uniformBlockIndex, arg2,  arg3 );

    DebugTest( 154 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetActiveUniformBlockiv( program=%d, uniformBlockIndex=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, program, uniformBlockIndex, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetActiveUniformBlockName ( GLuint program, GLuint uniformBlockIndex, GLsizei bufSize, GLsizei *length, GLchar *uniformBlockName, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetActiveUniformBlockName( %d, %d, %d, %s, %s );\n", file, line, program, uniformBlockIndex, bufSize, arg3,  arg4 );

    DebugTest( 153 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetActiveUniformBlockName( program=%d, uniformBlockIndex=%d, bufSize=%d, length=%s, uniformBlockName=%s ) at %s:%d\n", debug_break, program, uniformBlockIndex, bufSize, arg3, arg4, file, line );
        DebugFunction();
    }
...
void gldlDrawElementsBaseVertex ( GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLint basevertex, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDrawElementsBaseVertex( %s, %d, %s, %s, %d );\n", file, line, arg0, count, arg2, arg3,  basevertex );

    DebugTest( 107 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDrawElementsBaseVertex( mode=%s, count=%d, type=%s, indices=%s, basevertex=%d ) at %s:%d\n", debug_break, arg0, count, arg2, arg3, basevertex, file, line );
        DebugFunction();
    }
...
void gldlDrawRangeElementsBaseVertex ( GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices, GLint basevertex, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDrawRangeElementsBaseVertex( %s, %d, %d, %d, %s, %s, %d );\n", file, line, arg0, start, end, count, arg4, arg5,  basevertex );

    DebugTest( 114 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDrawRangeElementsBaseVertex( mode=%s, start=%d, end=%d, count=%d, type=%s, indices=%s, basevertex=%d ) at %s:%d\n", debug_break, arg0, start, end, count, arg4, arg5, basevertex, file, line );
        DebugFunction();
    }
...
void gldlDrawElementsInstancedBaseVertex ( GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei primcount, GLint basevertex, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDrawElementsInstancedBaseVertex( %s, %d, %s, %s, %d, %d );\n", file, line, arg0, count, arg2, arg3, primcount,  basevertex );

    DebugTest( 111 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDrawElementsInstancedBaseVertex( mode=%s, count=%d, type=%s, indices=%s, primcount=%d, basevertex=%d ) at %s:%d\n", debug_break, arg0, count, arg2, arg3, primcount, basevertex, file, line );
        DebugFunction();
    }
...
void gldlMultiDrawElementsBaseVertex ( GLenum mode, const GLsizei *count, GLenum type, const GLvoid* *indices, GLsizei primcount, const GLint *basevertex, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glMultiDrawElementsBaseVertex( %s, %s, %s, %s, %d, %s );\n", file, line, arg0, arg1, arg2, arg3, primcount,  arg5 );

    DebugTest( 278 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glMultiDrawElementsBaseVertex( mode=%s, count=%s, type=%s, indices=%s, primcount=%d, basevertex=%s ) at %s:%d\n", debug_break, arg0, arg1, arg2, arg3, primcount, arg5, file, line );
        DebugFunction();
    }
...
void gldlGetSynciv ( GLsync sync, GLenum pname, GLsizei bufSize, GLsizei *length, GLint *values, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetSynciv( %s, %s, %d, %s, %s );\n", file, line, arg0, arg1, bufSize, arg3,  arg4 );

    DebugTest( 210 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetSynciv( sync=%s, pname=%s, bufSize=%d, length=%s, values=%s ) at %s:%d\n", debug_break, arg0, arg1, bufSize, arg3, arg4, file, line );
        DebugFunction();
    }
...
void gldlGetMultisamplefv ( GLenum pname, GLuint index, GLfloat *val, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetMultisamplefv( %s, %d, %s );\n", file, line, arg0, index,  arg2 );

    DebugTest( 181 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetMultisamplefv( pname=%s, index=%d, val=%s ) at %s:%d\n", debug_break, arg0, index, arg2, file, line );
        DebugFunction();
    }
...
void gldlNamedStringARB ( GLenum type, GLint namelen, const GLchar *name, GLint stringlen, const GLchar *string, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glNamedStringARB( %s, %d, %s, %d, %s );\n", file, line, arg0, namelen, arg2, stringlen,  arg4 );

    DebugTest( 287 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glNamedStringARB( type=%s, namelen=%d, name=%s, stringlen=%d, string=%s ) at %s:%d\n", debug_break, arg0, namelen, arg2, stringlen, arg4, file, line );
        DebugFunction();
    }
...
void gldlDeleteNamedStringARB ( GLint namelen, const GLchar *name, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDeleteNamedStringARB( %d, %s );\n", file, line, namelen,  arg1 );

    DebugTest( 79 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDeleteNamedStringARB( namelen=%d, name=%s ) at %s:%d\n", debug_break, namelen, arg1, file, line );
        DebugFunction();
    }
...
void gldlCompileShaderIncludeARB ( GLuint shader, GLsizei count, const GLchar* *path, const GLint *length, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glCompileShaderIncludeARB( %d, %d, %s, %s );\n", file, line, shader, count, arg2,  arg3 );

    DebugTest( 56 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glCompileShaderIncludeARB( shader=%d, count=%d, path=%s, length=%s ) at %s:%d\n", debug_break, shader, count, arg2, arg3, file, line );
        DebugFunction();
    }
...
GLboolean gldlIsNamedStringARB ( GLint namelen, const GLchar *name, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glIsNamedStringARB( %d, %s );\n", file, line, namelen,  arg1 );
...
void gldlGetNamedStringARB ( GLint namelen, const GLchar *name, GLsizei bufSize, GLint *stringlen, GLchar *string, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetNamedStringARB( %d, %s, %d, %s, %s );\n", file, line, namelen, arg1, bufSize, arg3,  arg4 );

    DebugTest( 182 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetNamedStringARB( namelen=%d, name=%s, bufSize=%d, stringlen=%s, string=%s ) at %s:%d\n", debug_break, namelen, arg1, bufSize, arg3, arg4, file, line );
        DebugFunction();
    }
...
void gldlGetNamedStringivARB ( GLint namelen, const GLchar *name, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetNamedStringivARB( %d, %s, %s, %s );\n", file, line, namelen, arg1, arg2,  arg3 );

    DebugTest( 183 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetNamedStringivARB( namelen=%d, name=%s, pname=%s, params=%s ) at %s:%d\n", debug_break, namelen, arg1, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlBindFragDataLocationIndexed ( GLuint program, GLuint colorNumber, GLuint index, const GLchar *name, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glBindFragDataLocationIndexed( %d, %d, %d, %s );\n", file, line, program, colorNumber, index,  arg3 );

    DebugTest( 12 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glBindFragDataLocationIndexed( program=%d, colorNumber=%d, index=%d, name=%s ) at %s:%d\n", debug_break, program, colorNumber, index, arg3, file, line );
        DebugFunction();
    }
...
GLint gldlGetFragDataIndex ( GLuint program, const GLchar *name, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetFragDataIndex( %d, %s );\n", file, line, program,  arg1 );
...
void gldlGenSamplers ( GLsizei count, GLuint *samplers, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGenSamplers( %d, %s );\n", file, line, count,  arg1 );

    DebugTest( 142 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGenSamplers( count=%d, samplers=%s ) at %s:%d\n", debug_break, count, arg1, file, line );
        DebugFunction();
    }
...
void gldlDeleteSamplers ( GLsizei count, const GLuint *samplers, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDeleteSamplers( %d, %s );\n", file, line, count,  arg1 );

    DebugTest( 84 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDeleteSamplers( count=%d, samplers=%s ) at %s:%d\n", debug_break, count, arg1, file, line );
        DebugFunction();
    }
...
void gldlSamplerParameteriv ( GLuint sampler, GLenum pname, const GLint *param, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glSamplerParameteriv( %d, %s, %s );\n", file, line, sampler, arg1,  arg2 );

    DebugTest( 371 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glSamplerParameteriv( sampler=%d, pname=%s, param=%s ) at %s:%d\n", debug_break, sampler, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlSamplerParameterfv ( GLuint sampler, GLenum pname, const GLfloat *param, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glSamplerParameterfv( %d, %s, %s );\n", file, line, sampler, arg1,  arg2 );

    DebugTest( 369 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glSamplerParameterfv( sampler=%d, pname=%s, param=%s ) at %s:%d\n", debug_break, sampler, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlSamplerParameterIiv ( GLuint sampler, GLenum pname, const GLint *param, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glSamplerParameterIiv( %d, %s, %s );\n", file, line, sampler, arg1,  arg2 );

    DebugTest( 366 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glSamplerParameterIiv( sampler=%d, pname=%s, param=%s ) at %s:%d\n", debug_break, sampler, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlSamplerParameterIuiv ( GLuint sampler, GLenum pname, const GLuint *param, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glSamplerParameterIuiv( %d, %s, %s );\n", file, line, sampler, arg1,  arg2 );

    DebugTest( 367 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glSamplerParameterIuiv( sampler=%d, pname=%s, param=%s ) at %s:%d\n", debug_break, sampler, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetSamplerParameteriv ( GLuint sampler, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetSamplerParameteriv( %d, %s, %s );\n", file, line, sampler, arg1,  arg2 );

    DebugTest( 201 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetSamplerParameteriv( sampler=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, sampler, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetSamplerParameterIiv ( GLuint sampler, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetSamplerParameterIiv( %d, %s, %s );\n", file, line, sampler, arg1,  arg2 );

    DebugTest( 198 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetSamplerParameterIiv( sampler=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, sampler, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetSamplerParameterfv ( GLuint sampler, GLenum pname, GLfloat *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetSamplerParameterfv( %d, %s, %s );\n", file, line, sampler, arg1,  arg2 );

    DebugTest( 200 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetSamplerParameterfv( sampler=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, sampler, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetSamplerParameterIuiv ( GLuint sampler, GLenum pname, GLuint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetSamplerParameterIuiv( %d, %s, %s );\n", file, line, sampler, arg1,  arg2 );

    DebugTest( 199 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetSamplerParameterIuiv( sampler=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, sampler, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetQueryObjecti64v ( GLuint id, GLenum pname, GLint64 *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetQueryObjecti64v( %d, %s, %s );\n", file, line, id, arg1,  arg2 );

    DebugTest( 192 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetQueryObjecti64v( id=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, id, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetQueryObjectui64v ( GLuint id, GLenum pname, GLuint64 *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetQueryObjectui64v( %d, %s, %s );\n", file, line, id, arg1,  arg2 );

    DebugTest( 194 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetQueryObjectui64v( id=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, id, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribP1uiv ( GLuint index, GLenum type, GLboolean normalized, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribP1uiv( %d, %s, %d, %s );\n", file, line, index, arg1, normalized,  arg3 );

    DebugTest( 541 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribP1uiv( index=%d, type=%s, normalized=%d, value=%s ) at %s:%d\n", debug_break, index, arg1, normalized, arg3, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribP2uiv ( GLuint index, GLenum type, GLboolean normalized, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribP2uiv( %d, %s, %d, %s );\n", file, line, index, arg1, normalized,  arg3 );

    DebugTest( 543 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribP2uiv( index=%d, type=%s, normalized=%d, value=%s ) at %s:%d\n", debug_break, index, arg1, normalized, arg3, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribP3uiv ( GLuint index, GLenum type, GLboolean normalized, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribP3uiv( %d, %s, %d, %s );\n", file, line, index, arg1, normalized,  arg3 );

    DebugTest( 545 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribP3uiv( index=%d, type=%s, normalized=%d, value=%s ) at %s:%d\n", debug_break, index, arg1, normalized, arg3, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribP4uiv ( GLuint index, GLenum type, GLboolean normalized, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribP4uiv( %d, %s, %d, %s );\n", file, line, index, arg1, normalized,  arg3 );

    DebugTest( 547 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribP4uiv( index=%d, type=%s, normalized=%d, value=%s ) at %s:%d\n", debug_break, index, arg1, normalized, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniform1dv ( GLint location, GLsizei count, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform1dv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 417 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform1dv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform2dv ( GLint location, GLsizei count, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform2dv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 425 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform2dv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform3dv ( GLint location, GLsizei count, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform3dv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 433 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform3dv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniform4dv ( GLint location, GLsizei count, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniform4dv( %d, %d, %s );\n", file, line, location, count,  arg2 );

    DebugTest( 441 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniform4dv( location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, location, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix2dv ( GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix2dv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 449 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix2dv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix3dv ( GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix3dv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 455 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix3dv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix4dv ( GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix4dv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 461 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix4dv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix2x3dv ( GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix2x3dv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 451 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix2x3dv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix2x4dv ( GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix2x4dv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 453 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix2x4dv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix3x2dv ( GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix3x2dv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 457 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix3x2dv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix3x4dv ( GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix3x4dv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 459 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix3x4dv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix4x2dv ( GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix4x2dv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 463 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix4x2dv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlUniformMatrix4x3dv ( GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformMatrix4x3dv( %d, %d, %d, %s );\n", file, line, location, count, transpose,  arg3 );

    DebugTest( 465 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformMatrix4x3dv( location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, location, count, transpose, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetUniformdv ( GLuint program, GLint location, GLdouble *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetUniformdv( %d, %d, %s );\n", file, line, program, location,  arg2 );

    DebugTest( 223 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetUniformdv( program=%d, location=%d, params=%s ) at %s:%d\n", debug_break, program, location, arg2, file, line );
        DebugFunction();
    }
...
GLint gldlGetSubroutineUniformLocation ( GLuint program, GLenum shadertype, const GLchar *name, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetSubroutineUniformLocation( %d, %s, %s );\n", file, line, program, arg1,  arg2 );
...
GLuint gldlGetSubroutineIndex ( GLuint program, GLenum shadertype, const GLchar *name, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetSubroutineIndex( %d, %s, %s );\n", file, line, program, arg1,  arg2 );
...
void gldlGetActiveSubroutineUniformiv ( GLuint program, GLenum shadertype, GLuint index, GLenum pname, GLint *values, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetActiveSubroutineUniformiv( %d, %s, %d, %s, %s );\n", file, line, program, arg1, index, arg3,  arg4 );

    DebugTest( 151 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetActiveSubroutineUniformiv( program=%d, shadertype=%s, index=%d, pname=%s, values=%s ) at %s:%d\n", debug_break, program, arg1, index, arg3, arg4, file, line );
        DebugFunction();
    }
...
void gldlGetActiveSubroutineUniformName ( GLuint program, GLenum shadertype, GLuint index, GLsizei bufsize, GLsizei *length, GLchar *name, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetActiveSubroutineUniformName( %d, %s, %d, %d, %s, %s );\n", file, line, program, arg1, index, bufsize, arg4,  arg5 );

    DebugTest( 150 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetActiveSubroutineUniformName( program=%d, shadertype=%s, index=%d, bufsize=%d, length=%s, name=%s ) at %s:%d\n", debug_break, program, arg1, index, bufsize, arg4, arg5, file, line );
        DebugFunction();
    }
...
void gldlGetActiveSubroutineName ( GLuint program, GLenum shadertype, GLuint index, GLsizei bufsize, GLsizei *length, GLchar *name, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetActiveSubroutineName( %d, %s, %d, %d, %s, %s );\n", file, line, program, arg1, index, bufsize, arg4,  arg5 );

    DebugTest( 149 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetActiveSubroutineName( program=%d, shadertype=%s, index=%d, bufsize=%d, length=%s, name=%s ) at %s:%d\n", debug_break, program, arg1, index, bufsize, arg4, arg5, file, line );
        DebugFunction();
    }
...
void gldlUniformSubroutinesuiv ( GLenum shadertype, GLsizei count, const GLuint *indices, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glUniformSubroutinesuiv( %s, %d, %s );\n", file, line, arg0, count,  arg2 );

    DebugTest( 467 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glUniformSubroutinesuiv( shadertype=%s, count=%d, indices=%s ) at %s:%d\n", debug_break, arg0, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetUniformSubroutineuiv ( GLenum shadertype, GLint location, GLuint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetUniformSubroutineuiv( %s, %d, %s );\n", file, line, arg0, location,  arg2 );

    DebugTest( 222 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetUniformSubroutineuiv( shadertype=%s, location=%d, params=%s ) at %s:%d\n", debug_break, arg0, location, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetProgramStageiv ( GLuint program, GLenum shadertype, GLenum pname, GLint *values, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetProgramStageiv( %d, %s, %s, %s );\n", file, line, program, arg1, arg2,  arg3 );

    DebugTest( 189 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetProgramStageiv( program=%d, shadertype=%s, pname=%s, values=%s ) at %s:%d\n", debug_break, program, arg1, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlDeleteTransformFeedbacks ( GLsizei n, const GLuint *ids, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDeleteTransformFeedbacks( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 88 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDeleteTransformFeedbacks( n=%d, ids=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlGenTransformFeedbacks ( GLsizei n, GLuint *ids, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGenTransformFeedbacks( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 144 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGenTransformFeedbacks( n=%d, ids=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlGetQueryIndexediv ( GLenum target, GLuint index, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetQueryIndexediv( %s, %d, %s, %s );\n", file, line, arg0, index, arg2,  arg3 );

    DebugTest( 191 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetQueryIndexediv( target=%s, index=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, arg0, index, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlShaderBinary ( GLsizei count, const GLuint *shaders, GLenum binaryformat, const GLvoid *binary, GLsizei length, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glShaderBinary( %d, %s, %s, %s, %d );\n", file, line, count, arg1, arg2, arg3,  length );

    DebugTest( 378 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glShaderBinary( count=%d, shaders=%s, binaryformat=%s, binary=%s, length=%d ) at %s:%d\n", debug_break, count, arg1, arg2, arg3, length, file, line );
        DebugFunction();
    }
...
void gldlGetProgramBinary ( GLuint program, GLsizei bufSize, GLsizei *length, GLenum *binaryFormat, GLvoid *binary, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetProgramBinary( %d, %d, %s, %s, %s );\n", file, line, program, bufSize, arg2, arg3,  arg4 );

    DebugTest( 185 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetProgramBinary( program=%d, bufSize=%d, length=%s, binaryFormat=%s, binary=%s ) at %s:%d\n", debug_break, program, bufSize, arg2, arg3, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramBinary ( GLuint program, GLenum binaryFormat, const GLvoid *binary, GLsizei length, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramBinary( %d, %s, %s, %d );\n", file, line, program, arg1, arg2,  length );

    DebugTest( 303 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramBinary( program=%d, binaryFormat=%s, binary=%s, length=%d ) at %s:%d\n", debug_break, program, arg1, arg2, length, file, line );
        DebugFunction();
    }
...
GLuint gldlCreateShaderProgramv ( GLenum type, GLsizei count, const GLchar* *strings, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glCreateShaderProgramv( %s, %d, %s );\n", file, line, arg0, count,  arg2 );
...
void gldlDeleteProgramPipelines ( GLsizei n, const GLuint *pipelines, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDeleteProgramPipelines( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 81 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDeleteProgramPipelines( n=%d, pipelines=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlGenProgramPipelines ( GLsizei n, GLuint *pipelines, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGenProgramPipelines( %d, %s );\n", file, line, n,  arg1 );

    DebugTest( 139 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGenProgramPipelines( n=%d, pipelines=%s ) at %s:%d\n", debug_break, n, arg1, file, line );
        DebugFunction();
    }
...
void gldlGetProgramPipelineiv ( GLuint pipeline, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetProgramPipelineiv( %d, %s, %s );\n", file, line, pipeline, arg1,  arg2 );

    DebugTest( 188 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetProgramPipelineiv( pipeline=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, pipeline, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform1iv ( GLuint program, GLint location, GLsizei count, const GLint *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform1iv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 310 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform1iv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform1fv ( GLuint program, GLint location, GLsizei count, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform1fv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 308 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform1fv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform1dv ( GLuint program, GLint location, GLsizei count, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform1dv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 306 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform1dv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform1uiv ( GLuint program, GLint location, GLsizei count, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform1uiv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 312 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform1uiv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform2iv ( GLuint program, GLint location, GLsizei count, const GLint *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform2iv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 318 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform2iv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform2fv ( GLuint program, GLint location, GLsizei count, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform2fv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 316 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform2fv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform2dv ( GLuint program, GLint location, GLsizei count, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform2dv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 314 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform2dv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform2uiv ( GLuint program, GLint location, GLsizei count, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform2uiv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 320 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform2uiv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform3iv ( GLuint program, GLint location, GLsizei count, const GLint *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform3iv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 326 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform3iv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform3fv ( GLuint program, GLint location, GLsizei count, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform3fv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 324 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform3fv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform3dv ( GLuint program, GLint location, GLsizei count, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform3dv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 322 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform3dv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform3uiv ( GLuint program, GLint location, GLsizei count, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform3uiv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 328 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform3uiv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform4iv ( GLuint program, GLint location, GLsizei count, const GLint *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform4iv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 334 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform4iv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform4fv ( GLuint program, GLint location, GLsizei count, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform4fv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 332 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform4fv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform4dv ( GLuint program, GLint location, GLsizei count, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform4dv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 330 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform4dv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniform4uiv ( GLuint program, GLint location, GLsizei count, const GLuint *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniform4uiv( %d, %d, %d, %s );\n", file, line, program, location, count,  arg3 );

    DebugTest( 336 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniform4uiv( program=%d, location=%d, count=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, arg3, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix2fv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix2fv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 338 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix2fv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix3fv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix3fv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 344 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix3fv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix4fv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix4fv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 350 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix4fv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix2dv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix2dv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 337 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix2dv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix3dv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix3dv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 343 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix3dv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix4dv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix4dv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 349 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix4dv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix2x3fv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix2x3fv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 340 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix2x3fv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix3x2fv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix3x2fv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 346 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix3x2fv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix2x4fv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix2x4fv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 342 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix2x4fv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix4x2fv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix4x2fv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 352 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix4x2fv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix3x4fv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix3x4fv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 348 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix3x4fv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix4x3fv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix4x3fv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 354 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix4x3fv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix2x3dv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix2x3dv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 339 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix2x3dv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix3x2dv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix3x2dv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 345 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix3x2dv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix2x4dv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix2x4dv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 341 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix2x4dv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix4x2dv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix4x2dv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 351 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix4x2dv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix3x4dv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix3x4dv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 347 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix3x4dv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlProgramUniformMatrix4x3dv ( GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLdouble *value, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glProgramUniformMatrix4x3dv( %d, %d, %d, %d, %s );\n", file, line, program, location, count, transpose,  arg4 );

    DebugTest( 353 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glProgramUniformMatrix4x3dv( program=%d, location=%d, count=%d, transpose=%d, value=%s ) at %s:%d\n", debug_break, program, location, count, transpose, arg4, file, line );
        DebugFunction();
    }
...
void gldlGetProgramPipelineInfoLog ( GLuint pipeline, GLsizei bufSize, GLsizei *length, GLchar *infoLog, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetProgramPipelineInfoLog( %d, %d, %s, %s );\n", file, line, pipeline, bufSize, arg2,  arg3 );

    DebugTest( 187 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetProgramPipelineInfoLog( pipeline=%d, bufSize=%d, length=%s, infoLog=%s ) at %s:%d\n", debug_break, pipeline, bufSize, arg2, arg3, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribL1dv ( GLuint index, const GLdouble *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribL1dv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 532 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribL1dv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribL2dv ( GLuint index, const GLdouble *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribL2dv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 534 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribL2dv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribL3dv ( GLuint index, const GLdouble *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribL3dv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 536 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribL3dv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribL4dv ( GLuint index, const GLdouble *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribL4dv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 538 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribL4dv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlVertexAttribLPointer ( GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid *pointer, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glVertexAttribLPointer( %d, %d, %s, %d, %s );\n", file, line, index, size, arg2, stride,  arg4 );

    DebugTest( 539 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glVertexAttribLPointer( index=%d, size=%d, type=%s, stride=%d, pointer=%s ) at %s:%d\n", debug_break, index, size, arg2, stride, arg4, file, line );
        DebugFunction();
    }
...
void gldlGetVertexAttribLdv ( GLuint index, GLenum pname, GLdouble *params, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetVertexAttribLdv( %d, %s, %s );\n", file, line, index, arg1,  arg2 );

    DebugTest( 229 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetVertexAttribLdv( index=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, index, arg1, arg2, file, line );
        DebugFunction();
    }
...
void gldlViewportArrayv ( GLuint first, GLsizei count, const GLfloat *v, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glViewportArrayv( %d, %d, %s );\n", file, line, first, count,  arg2 );

    DebugTest( 556 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glViewportArrayv( first=%d, count=%d, v=%s ) at %s:%d\n", debug_break, first, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlViewportIndexedfv ( GLuint index, const GLfloat *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glViewportIndexedfv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 558 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glViewportIndexedfv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlScissorArrayv ( GLuint first, GLsizei count, const GLint *v, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glScissorArrayv( %d, %d, %s );\n", file, line, first, count,  arg2 );

    DebugTest( 373 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glScissorArrayv( first=%d, count=%d, v=%s ) at %s:%d\n", debug_break, first, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlScissorIndexedv ( GLuint index, const GLint *v, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glScissorIndexedv( %d, %s );\n", file, line, index,  arg1 );

    DebugTest( 375 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glScissorIndexedv( index=%d, v=%s ) at %s:%d\n", debug_break, index, arg1, file, line );
        DebugFunction();
    }
...
void gldlDepthRangeArrayv ( GLuint first, GLsizei count, const GLclampd *v, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDepthRangeArrayv( %d, %d, %s );\n", file, line, first, count,  arg2 );

    DebugTest( 93 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDepthRangeArrayv( first=%d, count=%d, v=%s ) at %s:%d\n", debug_break, first, count, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetFloati_v ( GLenum target, GLuint index, GLfloat *data, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetFloati_v( %s, %d, %s );\n", file, line, arg0, index,  arg2 );

    DebugTest( 170 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetFloati_v( target=%s, index=%d, data=%s ) at %s:%d\n", debug_break, arg0, index, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetDoublei_v ( GLenum target, GLuint index, GLdouble *data, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetDoublei_v( %s, %d, %s );\n", file, line, arg0, index,  arg2 );

    DebugTest( 167 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetDoublei_v( target=%s, index=%d, data=%s ) at %s:%d\n", debug_break, arg0, index, arg2, file, line );
        DebugFunction();
    }
...
void gldlDebugMessageControlARB ( GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint *ids, GLboolean enabled, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDebugMessageControlARB( %s, %s, %s, %d, %s, %d );\n", file, line, arg0, arg1, arg2, count, arg4,  enabled );

    DebugTest( 75 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDebugMessageControlARB( source=%s, type=%s, severity=%s, count=%d, ids=%s, enabled=%d ) at %s:%d\n", debug_break, arg0, arg1, arg2, count, arg4, enabled, file, line );
        DebugFunction();
    }
...
void gldlDebugMessageInsertARB ( GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar *buf, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDebugMessageInsertARB( %s, %s, %d, %s, %d, %s );\n", file, line, arg0, arg1, id, arg3, length,  arg5 );

    DebugTest( 76 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDebugMessageInsertARB( source=%s, type=%s, id=%d, severity=%s, length=%d, buf=%s ) at %s:%d\n", debug_break, arg0, arg1, id, arg3, length, arg5, file, line );
        DebugFunction();
    }
...
GLuint gldlGetDebugMessageLogARB ( GLuint count, GLsizei bufsize, GLenum *sources, GLenum *types, GLuint *ids, GLenum *severities, GLsizei *lengths, GLchar *messageLog, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *arg7, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetDebugMessageLogARB( %d, %d, %s, %s, %s, %s, %s, %s );\n", file, line, count, bufsize, arg2, arg3, arg4, arg5, arg6,  arg7 );
...
void gldlGetnMapdvARB ( GLenum target, GLenum query, GLsizei bufSize, GLdouble *v, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnMapdvARB( %s, %s, %d, %s );\n", file, line, arg0, arg1, bufSize,  arg3 );

    DebugTest( 238 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnMapdvARB( target=%s, query=%s, bufSize=%d, v=%s ) at %s:%d\n", debug_break, arg0, arg1, bufSize, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetnMapfvARB ( GLenum target, GLenum query, GLsizei bufSize, GLfloat *v, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnMapfvARB( %s, %s, %d, %s );\n", file, line, arg0, arg1, bufSize,  arg3 );

    DebugTest( 239 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnMapfvARB( target=%s, query=%s, bufSize=%d, v=%s ) at %s:%d\n", debug_break, arg0, arg1, bufSize, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetnMapivARB ( GLenum target, GLenum query, GLsizei bufSize, GLint *v, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnMapivARB( %s, %s, %d, %s );\n", file, line, arg0, arg1, bufSize,  arg3 );

    DebugTest( 240 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnMapivARB( target=%s, query=%s, bufSize=%d, v=%s ) at %s:%d\n", debug_break, arg0, arg1, bufSize, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetnPixelMapfvARB ( GLenum map, GLsizei bufSize, GLfloat *values, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnPixelMapfvARB( %s, %d, %s );\n", file, line, arg0, bufSize,  arg2 );

    DebugTest( 242 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnPixelMapfvARB( map=%s, bufSize=%d, values=%s ) at %s:%d\n", debug_break, arg0, bufSize, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetnPixelMapuivARB ( GLenum map, GLsizei bufSize, GLuint *values, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnPixelMapuivARB( %s, %d, %s );\n", file, line, arg0, bufSize,  arg2 );

    DebugTest( 243 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnPixelMapuivARB( map=%s, bufSize=%d, values=%s ) at %s:%d\n", debug_break, arg0, bufSize, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetnPixelMapusvARB ( GLenum map, GLsizei bufSize, GLushort *values, const char *arg0, const char *arg1, const char *arg2, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnPixelMapusvARB( %s, %d, %s );\n", file, line, arg0, bufSize,  arg2 );

    DebugTest( 244 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnPixelMapusvARB( map=%s, bufSize=%d, values=%s ) at %s:%d\n", debug_break, arg0, bufSize, arg2, file, line );
        DebugFunction();
    }
...
void gldlGetnPolygonStippleARB ( GLsizei bufSize, GLubyte *pattern, const char *arg0, const char *arg1, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnPolygonStippleARB( %d, %s );\n", file, line, bufSize,  arg1 );

    DebugTest( 245 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnPolygonStippleARB( bufSize=%d, pattern=%s ) at %s:%d\n", debug_break, bufSize, arg1, file, line );
        DebugFunction();
    }
...
void gldlGetnColorTableARB ( GLenum target, GLenum format, GLenum type, GLsizei bufSize, GLvoid *table, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnColorTableARB( %s, %s, %s, %d, %s );\n", file, line, arg0, arg1, arg2, bufSize,  arg4 );

    DebugTest( 234 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnColorTableARB( target=%s, format=%s, type=%s, bufSize=%d, table=%s ) at %s:%d\n", debug_break, arg0, arg1, arg2, bufSize, arg4, file, line );
        DebugFunction();
    }
...
void gldlGetnConvolutionFilterARB ( GLenum target, GLenum format, GLenum type, GLsizei bufSize, GLvoid *image, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnConvolutionFilterARB( %s, %s, %s, %d, %s );\n", file, line, arg0, arg1, arg2, bufSize,  arg4 );

    DebugTest( 236 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnConvolutionFilterARB( target=%s, format=%s, type=%s, bufSize=%d, image=%s ) at %s:%d\n", debug_break, arg0, arg1, arg2, bufSize, arg4, file, line );
        DebugFunction();
    }
...
void gldlGetnSeparableFilterARB ( GLenum target, GLenum format, GLenum type, GLsizei rowBufSize, GLvoid *row, GLsizei columnBufSize, GLvoid *column, GLvoid *span, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *arg7, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnSeparableFilterARB( %s, %s, %s, %d, %s, %d, %s, %s );\n", file, line, arg0, arg1, arg2, rowBufSize, arg4, columnBufSize, arg6,  arg7 );

    DebugTest( 246 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnSeparableFilterARB( target=%s, format=%s, type=%s, rowBufSize=%d, row=%s, columnBufSize=%d, column=%s, span=%s ) at %s:%d\n", debug_break, arg0, arg1, arg2, rowBufSize, arg4, columnBufSize, arg6, arg7, file, line );
        DebugFunction();
    }
...
void gldlGetnHistogramARB ( GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, GLvoid *values, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnHistogramARB( %s, %d, %s, %s, %d, %s );\n", file, line, arg0, reset, arg2, arg3, bufSize,  arg5 );

    DebugTest( 237 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnHistogramARB( target=%s, reset=%d, format=%s, type=%s, bufSize=%d, values=%s ) at %s:%d\n", debug_break, arg0, reset, arg2, arg3, bufSize, arg5, file, line );
        DebugFunction();
    }
...
void gldlGetnMinmaxARB ( GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, GLvoid *values, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnMinmaxARB( %s, %d, %s, %s, %d, %s );\n", file, line, arg0, reset, arg2, arg3, bufSize,  arg5 );

    DebugTest( 241 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnMinmaxARB( target=%s, reset=%d, format=%s, type=%s, bufSize=%d, values=%s ) at %s:%d\n", debug_break, arg0, reset, arg2, arg3, bufSize, arg5, file, line );
        DebugFunction();
    }
...
void gldlGetnTexImageARB ( GLenum target, GLint level, GLenum format, GLenum type, GLsizei bufSize, GLvoid *img, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnTexImageARB( %s, %d, %s, %s, %d, %s );\n", file, line, arg0, level, arg2, arg3, bufSize,  arg5 );

    DebugTest( 247 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnTexImageARB( target=%s, level=%d, format=%s, type=%s, bufSize=%d, img=%s ) at %s:%d\n", debug_break, arg0, level, arg2, arg3, bufSize, arg5, file, line );
        DebugFunction();
    }
...
void gldlReadnPixelsARB ( GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, GLvoid *data, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *arg7, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glReadnPixelsARB( %d, %d, %d, %d, %s, %s, %d, %s );\n", file, line, x, y, width, height, arg4, arg5, bufSize,  arg7 );

    DebugTest( 359 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glReadnPixelsARB( x=%d, y=%d, width=%d, height=%d, format=%s, type=%s, bufSize=%d, data=%s ) at %s:%d\n", debug_break, x, y, width, height, arg4, arg5, bufSize, arg7, file, line );
        DebugFunction();
    }
...
void gldlGetnCompressedTexImageARB ( GLenum target, GLint lod, GLsizei bufSize, GLvoid *img, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnCompressedTexImageARB( %s, %d, %d, %s );\n", file, line, arg0, lod, bufSize,  arg3 );

    DebugTest( 235 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnCompressedTexImageARB( target=%s, lod=%d, bufSize=%d, img=%s ) at %s:%d\n", debug_break, arg0, lod, bufSize, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetnUniformfvARB ( GLuint program, GLint location, GLsizei bufSize, GLfloat *params, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnUniformfvARB( %d, %d, %d, %s );\n", file, line, program, location, bufSize,  arg3 );

    DebugTest( 249 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnUniformfvARB( program=%d, location=%d, bufSize=%d, params=%s ) at %s:%d\n", debug_break, program, location, bufSize, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetnUniformivARB ( GLuint program, GLint location, GLsizei bufSize, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnUniformivARB( %d, %d, %d, %s );\n", file, line, program, location, bufSize,  arg3 );

    DebugTest( 250 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnUniformivARB( program=%d, location=%d, bufSize=%d, params=%s ) at %s:%d\n", debug_break, program, location, bufSize, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetnUniformuivARB ( GLuint program, GLint location, GLsizei bufSize, GLuint *params, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnUniformuivARB( %d, %d, %d, %s );\n", file, line, program, location, bufSize,  arg3 );

    DebugTest( 251 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnUniformuivARB( program=%d, location=%d, bufSize=%d, params=%s ) at %s:%d\n", debug_break, program, location, bufSize, arg3, file, line );
        DebugFunction();
    }
...
void gldlGetnUniformdvARB ( GLuint program, GLint location, GLsizei bufSize, GLdouble *params, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetnUniformdvARB( %d, %d, %d, %s );\n", file, line, program, location, bufSize,  arg3 );

    DebugTest( 248 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetnUniformdvARB( program=%d, location=%d, bufSize=%d, params=%s ) at %s:%d\n", debug_break, program, location, bufSize, arg3, file, line );
        DebugFunction();
    }
...
void gldlDrawElementsInstancedBaseInstance ( GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei primcount, GLuint baseinstance, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDrawElementsInstancedBaseInstance( %s, %d, %s, %s, %d, %d );\n", file, line, arg0, count, arg2, arg3, primcount,  baseinstance );

    DebugTest( 110 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDrawElementsInstancedBaseInstance( mode=%s, count=%d, type=%s, indices=%s, primcount=%d, baseinstance=%d ) at %s:%d\n", debug_break, arg0, count, arg2, arg3, primcount, baseinstance, file, line );
        DebugFunction();
    }
...
void gldlDrawElementsInstancedBaseVertexBaseInstance ( GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei primcount, GLint basevertex, GLuint baseinstance, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *arg5, const char *arg6, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glDrawElementsInstancedBaseVertexBaseInstance( %s, %d, %s, %s, %d, %d, %d );\n", file, line, arg0, count, arg2, arg3, primcount, basevertex,  baseinstance );

    DebugTest( 112 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glDrawElementsInstancedBaseVertexBaseInstance( mode=%s, count=%d, type=%s, indices=%s, primcount=%d, basevertex=%d, baseinstance=%d ) at %s:%d\n", debug_break, arg0, count, arg2, arg3, primcount, basevertex, baseinstance, file, line );
        DebugFunction();
    }
...
void gldlGetInternalformativ ( GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *arg4, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetInternalformativ( %s, %s, %s, %d, %s );\n", file, line, arg0, arg1, arg2, bufSize,  arg4 );

    DebugTest( 180 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetInternalformativ( target=%s, internalformat=%s, pname=%s, bufSize=%d, params=%s ) at %s:%d\n", debug_break, arg0, arg1, arg2, bufSize, arg4, file, line );
        DebugFunction();
    }
...
void gldlGetActiveAtomicCounterBufferiv ( GLuint program, GLuint bufferIndex, GLenum pname, GLint *params, const char *arg0, const char *arg1, const char *arg2, const char *arg3, const char *file, int line ) {
    ...
    for( i = 0; i < TRACE_N; ++i ) 
        if( gldl_traces[i].started )
            fprintf( gldl_traces[i].f, "call<%s,%d>: glGetActiveAtomicCounterBufferiv( %d, %d, %s, %s );\n", file, line, program, bufferIndex, arg2,  arg3 );

    DebugTest( 147 );
    if( debug_break[0] ) {
        printf( "Breakpoint %s on glGetActiveAtomicCounterBufferiv( program=%d, bufferIndex=%d, pname=%s, params=%s ) at %s:%d\n", debug_break, program, bufferIndex, arg2, arg3, file, line );
        DebugFunction();
    }
